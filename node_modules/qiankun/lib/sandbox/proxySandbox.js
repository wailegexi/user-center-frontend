...
var cachedGlobals = Array.from(new Set(_without2.default.apply(void 0, [[].concat((0, _toConsumableArray2.default)(_globals.globals), (0, _toConsumableArray2.default)(overwrittenGlobals), ['requestAnimationFrame'])].concat(accessingSpiedGlobals))));
 ...
 */
var unscopables = _without2.default.apply(void 0, [cachedGlobals].concat((0, _toConsumableArray2.default)(overwrittenGlobals))).reduce(
