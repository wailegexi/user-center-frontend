...
export var cachedGlobals = Array.from(new Set(_without.apply(void 0, [[].concat(_toConsumableArray(globals), _toConsumableArray(overwrittenGlobals), ['requestAnimationFrame'])].concat(accessingSpiedGlobals))));
 ...
 */
var unscopables = _without.apply(void 0, [cachedGlobals].concat(_toConsumableArray(overwrittenGlobals))).reduce(
